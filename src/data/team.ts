...
export const team: Member[] = [
  { name: 'Абдуллаева Даяна',  role: 'Руководитель проекта · Аналитик', vk: 'abdllvdn',     tg: 'abdllvdn',         max: 'https://max.ru/u/f9LHodD0cOIGHIwD4fYzPiy4ZLGRuonAcNztgquZnajX1Um92VWWR_kKsjM',        email: 'dayanaab@yandex.ru', phone: '+79185776166', photo: '/assets/photos/abdllvdn.jpg' },
  { name: 'Чубухчиев Борис',   role: 'Fullstack-разработчик',              vk: 'borischubuh',          tg: 'bosicoChan', max: '',                email: 'borischubuhchiev@mail.ru',  phone: '', photo: '/assets/photos/barb.jpg' },
