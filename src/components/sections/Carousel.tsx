...
const slides: Slide[] = [
  {
    imgSrc: '/assets/screens/screen-camera.webp', title: 'AI-зрение 24/7',
  ...
  {
    imgSrc: '/assets/screens/screen-money.webp', title: 'Распознавание купюр',
  ...
  {
    imgSrc: '/assets/screens/screen-chat.webp', title: 'Диалог с ассистентом',
    body: 'После любого распознавания можно продолжить разговор: уточнить детали, переспросить о чём-то конкретном — например, что лежит на подоконнике. ИИ помнит контекст и отвечает голосом.',
    label: 'Экран диалога: пользователь уточняет детали у ассистента.',
  },
  {
    imgSrc: '/assets/screens/screen-home.webp', title: 'Голосовое управление',
  ...
  {
    imgSrc: '/assets/screens/screen-volunteer.webp', title: 'Связь с волонтёром',
  ...
  {
    imgSrc: '/assets/screens/screen-history.webp', title: 'История запросов',
